---
title: 🇩🇪 交換生生存指南（三）到德國後要做什麼｜行政事項篇
date: 2026-03-28T15:49:32+08:00
draft: false
aliases:
  - 🇩🇪 交換生生存指南（三）到德國後要做什麼｜行政事項篇
description: 抵達德國後該先做什麼？本篇整理交換生前兩週必辦行政事項，包括 Anmeldung 入籍、限制提領帳戶啟用、TK 公保開通、稅號與廣電費處理流程，搭配實際時間線與經驗分享，協助你順利展開德國交換生活。
slug: exchange-student-survival-guide-3-1-administrative-matters-after-arrival-in-germany
...
{{< timelineItem icon="bars" header="抵達德國" badge="3月11日" >}}
...
{{< timelineItem icon="check" header="線上預約德國入籍 Termin" badge="3月9日" >}}

不一定要像我一樣那麼早預約，通常可在入住前一至兩週再預約即可；我個人則是預約了 4/8 辦理。

{{< figure src="assets/index/file-20260322145830572-78ab601e-1140-4c64-89f0-47a24030073f.png" caption="▲ 預約成功畫面" class="grid-w50" >}}
...
{{< gallery >}}
  <img src="assets/index/file-20260322123518803-5ea953db-1a70-4ae9-8f2c-1be1928acd06.png" class="grid-w50" />
  <img src="assets/index/file-20260322124003893-811a43c6-4ea3-42ca-afa5-5a61896a184f.png" class="grid-w50" />
{{< /gallery >}}

預約類型請選擇 **Wohnsitzanmeldung**，接著選擇時間與地點，填寫聯絡資訊後送出即可。

{{< gallery >}}
  <img src="assets/index/file-20260322124024656-2813f1ef-676b-4691-aaa1-290fd3c9ed94.png" class="grid-w50" />
  <img src="assets/index/file-20260322125407360-5ffe9e8f-7a5d-4703-8ba5-bd9b82db9666.png" class="grid-w50" />
  <img src="assets/index/file-20260322125418612-5391cc5c-ae83-4c44-8ce8-52e700265ac6.png" class="grid-w50" />
  <img src="assets/index/file-20260322125427252-42058324-cef4-4240-87e5-399f8e893c2c.png" class="grid-w50" />
{{< /gallery >}}
...
{{< timelineItem icon="email" header="收到宿舍方「居住提供證明」" badge="3月31日" >}}

<b>Wohnungsgeberbestätigung</b>，中文為「居住提供證明」或「住宅提供者確認書」，是入籍時必備的文件之一。

{{< figure src="assets/index/file-20260322152128310-5cae8325-0581-4830-9ace-ad666ddaff23.png" caption="▲ 居住提供證明 Wohnungsgeberbestätigung" >}}

{{< /timelineItem >}}

{{< timelineItem icon="circle-info" header="宿舍入住日" badge="4月1日" >}}

這是我宿舍的最早可入住日期，但實際情況是我當時人正在希臘，於是請了同樣去交換的同學幫我拿鑰匙 XD。

{{< /timelineItem >}}

{{< timelineItem icon="location-dot" header="現場辦理入籍" badge="4月8日" >}}

當天我提早了約二十分鐘到現場等待叫號（收到的預約確認信裡面有號碼）。辦理的過程大概十分鐘而已，對方也能用英文溝通，整體還算順利。

{{< figure src="assets/index/file-20260322145524271-9692a1ff-93e0-4e60-ad52-6e037a5da1a5.jpeg" caption="▲ Bürgerbüro Leonrodstraße 現場排隊等候" class="grid-w50" >}}
...
{{< timelineItem icon="envelope" header="收到內含「税號」的信" badge="4月21日" >}}

{{< figure src="assets/index/file-20260322154144164-a45279e3-596f-453d-8847-9fe85274a1cc.png" caption="▲ 稅號實體信" >}}
...
{{< timelineItem icon="envelope" header="收到「廣電費繳費通知」" badge="5月初" >}}

{{< figure src="assets/index/file-20260322161137836-e6dd9a9f-9351-4d0b-a041-87e35fc2f707.png" caption="▲ 廣播電視費實體信" >}}
...
{{< timelineItem icon="file-lines" header="上傳開通 Expatrio 限制提領帳戶所需文件" badge="4月8日" >}}

上傳相關文件後，發現非真人驗證時段，只好等到隔天上班時間再弄 XD。

{{< figure src="assets/index/file-20260328140237472-71d2b43e-acfa-4ce0-a6ca-a463b073b039.png" caption="▲ 文件審核通過通知" >}}

{{< /timelineItem >}}

{{< timelineItem icon="phone" header="真人客服驗證" badge="4月9日" >}}

真人驗證需準備護照和上述文件，並可選擇英文服務；接線員一臉厭世，講話也很快但就照他指示出示護照、唸號碼與生日等資訊就行，整個流程約五分鐘。

{{< figure src="assets/index/file-20260328140310817-e6f9fa37-5876-49f0-9cbc-a5d353dbfdad.png" caption="▲ 驗證通過通知" >}}

{{< /timelineItem >}}

{{< timelineItem icon="file-lines" header="第一筆款項 €992 入帳" badge="4月9日" >}}

實際入帳速度相當快，當天完成開通後約半小時便收到第一筆凍結金，甚至第二、第三筆也在當天入帳。

{{< figure src="assets/index/file-20260328140350689-28c57285-63e9-40b8-b917-0bce36bf2f6a.png" caption="▲ 第一筆凍結金額（三月份）撥款通知" >}}

{{< /timelineItem >}}

{{< timelineItem icon="bars" header="後續款項入帳" badge="每月25日" >}}

後續款項則固定於每月 25 日發放，因此無需擔心生活費未能按時入帳。

{{< figure src="assets/index/file-20260328135554660-e044ac9e-c589-478a-bf29-2d3e6a0642c5.png" caption="▲ 最後一筆凍結金額（九月份）和剩餘緩衝金撥款通知" >}}
...
{{< timelineItem icon="file-lines" header="上傳相關資料" badge="4月10日" >}}

上傳完成後，會收到以下 email，等待資料審核。

{{< figure src="assets/index/file-20260325205457960-4f71042d-26af-41fe-92f5-6b4c4a903cf8.png" caption="▲ 上傳完狀態更新" >}}
...
{{< gallery >}}
<img src="assets/index/file-20260325203602341-93c1ab11-1421-443d-b14f-78157054b409.jpeg" class="grid-w33" />
<img src="assets/index/file-20260325203602370-a18c1584-275c-4e4b-9ed1-182c3b00c275.jpeg" class="grid-w33" />
<img src="assets/index/file-20260325211025444-ce810ad8-45af-42bb-8b3b-8ad6a63c0716.png" class="grid-w33" />
{{< /gallery >}}

{{< timeline >}}

{{< timelineItem icon="email" header="收到 TK 開通成功 email" badge="4月11日" >}}

信中會說明接下來將寄出實體信件與開通碼（可用於線上註冊 TK 帳號），同時過陣子也會收到 EHIC 歐盟健保卡；ISIC 則會另外以 email 形式寄送。

{{< figure src="assets/index/file-20260325205834918-2a7c85d3-bcd4-445a-a2b7-04c1d52e3c7b.png" caption="▲ TK 開通成功 email" >}}
...
{{< timelineItem icon="envelope" header="收到實體信" badge="4月15日" >}}

後續陸續收到幾封實體信件，包括先前 email 收到的四份文件紙本、上傳健保卡大頭貼的說明、銀行帳戶綁定確認信，以及含有個人保險號碼（Versicherungsnummer）的通知信；保險號碼那封建議妥善保存。

{{< figure src="assets/index/file-20260325210140914-f7e70907-88d2-4334-b8f7-3d3fbdb999df.jpeg" caption="▲ 收到一堆信..." class="grid-w50" >}}

{{< /timelineItem >}}

{{< timelineItem icon="pgpkey" header="收到開通碼 Activation Code 的信" badge="4月21日" >}}

註冊 TK 需要使用開通碼，以及收到實體卡後卡片上的十位數保險號碼，而不是先前信件中的個人保險號碼（Versicherungsnummer），因此還需要再等實體卡寄到。

{{< figure src="assets/index/file-20260325210627410-3fe7415a-fb66-48a8-a1a8-fb4254bf12c4.jpeg" caption="▲ 開通碼 Activation Code 實體信" >}}

{{< /timelineItem >}}

{{< timelineItem icon="envelope" header="收到 EHIC 健保實體卡" badge="4月29日" >}}
...
{{< timelineItem icon="bars" header="申請 69 歐返現" badge="5月8日" >}}

啟用公保後，會收到一封 email 通知，表示可申請領取 Expatrio 大禮包的 69 歐元返現，約一週後款項便入帳。

{{< figure src="assets/index/file-20260325211025410-9e67ebce-6b73-43ac-8afc-8e6ffb6c867a.png" caption="▲ 點擊 Cashback" class="grid-w50" >}}

{{< /timelineItem >}}

{{< timelineItem icon="email" header="收到 ISIC 電子學生證" badge="6月12日" >}}

等了相當久，終於收到 ISIC 學生證的電子郵件。下載 App 後開通流程其實很快速簡單，不過實際上我幾乎沒有用到它 XD。

{{< figure src="assets/index/file-20260325212059692-642880d5-6b1d-422e-9962-4243ace973b3.png" caption="▲ ISIC email" >}}
